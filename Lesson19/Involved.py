...
def involved(courses, person):
    ...
    for hexamester in courses:
        for coursename in courses[hexamester]:
            for key in courses[hexamester][coursename]:
                if courses[hexamester][coursename][key] == person:
                    if hexamester in list:
                        list[hexamester].append(coursename)
                    else:
                        list[hexamester] = [coursename]
